...
const EFFECT_NAME = 'reverb';

const PARAMS = [
  { name: 'room_size', label: 'Room Size', min: 0, max: 1, step: 0.01, default: 0.5 },
  { name: 'damping', label: 'Damping', min: 0, max: 1, step: 0.01, default: 0.5 },
  { name: 'wet_level', label: 'Wet Level', min: 0, max: 1, step: 0.01, default: 0.3 },
  { name: 'dry_level', label: 'Dry Level', min: 0, max: 1, step: 0.01, default: 0.7 },
  { name: 'width', label: 'Width', min: 0, max: 1, step: 0.01, default: 1 },
] as const;

type ParamName = (typeof PARAMS)[number]['name'];

export function ReverbSettings() {
